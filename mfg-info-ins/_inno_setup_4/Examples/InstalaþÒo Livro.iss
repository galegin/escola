...
[Setup]
AppName=Sistema Livro
AppVerName=Sistema Livro 1.0
...
DefaultDirName=\MFG-Info\Livro
DefaultGroupName=Livro
OutputDir=C:\CD\Sistema
OutputBaseFilename=Instalação Livro
Compression=lzma
...
Source: C:\MFG-Info\Livro\Dados\*; DestDir: {app}\Dados; Flags: ignoreversion recursesubdirs
Source: C:\MFG-Info\Livro\Sistema\*; DestDir: {app}\Sistema; Flags: ignoreversion recursesubdirs
...
[Icons]
Name: {group}\Livro; Filename: {app}\Sistema\Livro.exe
Name: {userdesktop}\Livro; Filename: {app}\Sistema\Livro.exe; Tasks: desktopicon
...
Filename: {app}\Sistema\Livro.exe; Description: {cm:LaunchProgram,Livro}; Flags: nowait postinstall skipifsilent
