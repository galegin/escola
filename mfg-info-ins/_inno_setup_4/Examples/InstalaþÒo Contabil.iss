...
[Setup]
AppName=Sistema Contabil
AppVerName=Sistema Contabil 1.0
...
DefaultDirName=\MFG-Info\Contabil
DefaultGroupName=Contabil
OutputDir=C:\CD\Sistema
OutputBaseFilename=Instalação Contabil
Compression=lzma
...
Source: C:\MFG-Info\Contabil\Dados\*; DestDir: {app}\Dados; Flags: ignoreversion recursesubdirs
Source: C:\MFG-Info\Contabil\Sistema\*; DestDir: {app}\Sistema; Flags: ignoreversion recursesubdirs
...
[Icons]
Name: {group}\Contabil; Filename: {app}\Sistema\Contabil.exe
Name: {userdesktop}\Contabil; Filename: {app}\Sistema\Contabil.exe; Tasks: desktopicon
...
Filename: {app}\Sistema\Contabil.exe; Description: {cm:LaunchProgram,Contabil}; Flags: nowait postinstall skipifsilent
